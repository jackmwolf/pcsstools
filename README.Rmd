...
In this case, our coefficient estimates for everything but the intercept are off by a factor of -1; this is because we picked the opposite vector of principal component weights to `prcomp`.
