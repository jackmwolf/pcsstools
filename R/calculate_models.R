...
#'   principal component score to analyze.
#'   
...
#' )
#' 
#' pcsslm(y1 + y2 + y3 ~ g + x, pcss = pcss, comp = 1)
#' 
...
#' )
#' 
#' pcsslm(y1 + y2 ~ g + x, pcss = pcss, phi = c(1, -1))
#' summary(lm(y1 - y2 ~ g + x, data = ex_data))
#' 
...
#' )
#'
#' pcsslm(y1 * y2 * y3 ~ g + x, pcss = pcss, response = "binary")
