...
getCoefs.grass <- function(slopes, intercepts, maf = NULL,
...
getSE.grass <- function(slopes, intercepts, maf, varCovar, yBar, n, predBeta,
                                 inheritance){
  ...
  for (i in 2:length(slopes)){
    ...
    recBeta[i] <- getCoefs.summaryStatReg(slopes = pairWiseBetas,
